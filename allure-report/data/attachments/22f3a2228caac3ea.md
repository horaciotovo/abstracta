...
- Name: products\product-listing.spec.ts >> Demoblaze Product Listing >> should extract all products from first and second page
- Location: tests\products\product-listing.spec.ts:17:9
