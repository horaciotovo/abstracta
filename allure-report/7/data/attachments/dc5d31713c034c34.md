...
Locator: getByRole('link', { name: 'Welcome testuser_1777923156807' })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Welcome testuser_1777923156807' })
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          ...
          - generic [ref=e13]:
            ...
            - textbox [ref=e15]: TestPass_1777923156807!
        - generic [ref=e17]:
